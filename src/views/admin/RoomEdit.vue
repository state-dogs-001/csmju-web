...
export default {
  ...
  methods: {
    ...
    EditProduct() {
      this.id = this.$store.state.roomEdit;
      http.get(`classroom/id/${this.id}`).then((response) => {
        this.Classroom_Name = response.data.Classroom_Name;
        this.Classroom_Type = response.data.Classroom_Type;
        this.Classroom_Number = response.data.Classroom_Number;
        this.Classroom_sit = response.data.Classroom_sit;
        this.Classroom_Detail = response.data.Classroom_Detail;
        this.imgUrl = response.data.Classroom_Images;
      });
    },
    submitForm() {
      this.v$.$validate();
      if (!this.v$.$error) {
        ...
        http.post(`classroom/update/${this.id}`, data).then(() => {
